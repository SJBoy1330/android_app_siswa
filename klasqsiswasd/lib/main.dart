...
import 'package:klasqsiswasd/popup.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  String mainURL = "https://sd.klasq.id/app_siswa/";
  ...
  void setCookies() async {
    ...
    await cookieManager.setCookie(
      url: Uri.parse(mainURL),
      name: "FCM_TOKEN",
      value: "${await msg.getToken()}",
    );
    print("fcm: ${await msg.getToken()}");
  }
                ...
                child: Stack(
                  children: [
                    ...
                    isCurrentlyLoading ? LinearProgressIndicator(
                      value: loadProgress,
                      color: const Color(0xFFEC3528),
                      backgroundColor: const Color(0x33757575),
